...
import com.csci4050.api.service.OrderService;
...
public class OrderController {
	...
	@PostMapping("/order")
	public ResponseEntity<?> createMovie(@RequestBody Order order) throws Exception {
		return new ResponseEntity<>(orderService.createOrder(order), HttpStatus.CREATED);
	}
	
	@GetMapping("/orders/user/{userId}")
	public ResponseEntity<?> getUserMovies(@PathVariable("userId") Long userId) {
